...
var Contract = (function () {
    function Contract(contract) {
        ...
        var _properties = {
            ...
            network: function () {
                ...
                if (network_id == null) {
                    throw new Error(this.contractName +
            ...
            binary: function () {
                return utils_1.default.linkBytecode(this.bytecode, this.links);
            },
            deployedBinary: function () {
                return utils_1.default.linkBytecode(this.deployedBytecode, this.links);
            },
            unlinked_binary: {
                get: function () {
        ...
        utils_1.default.bootstrap(Contract);
    }
        ...
        return self
            ...
            if (unlinked_libraries != null) {
                unlinked_libraries = unlinked_libraries
                    ...
                    .join(', ');
                throw new Error(self.contractName +
            ...
            return new Promise(function (accept, reject) {
                ...
                if (utils_1.default.is_object(last_arg) && !utils_1.default.is_big_number(last_arg)) {
                    tx_params = args.pop();
                }
                ...
                tx_params = utils_1.default.merge(self.class_defaults, tx_params);
    ...
    Contract.detectNetwork = function () {
        ...
        return new Promise(function (accept, reject) {
            ...
            self.web3.version.getNetwork(function (err, result) {
                ...
                utils_1.default.parallel(matches, function (err, results) {
                    if (err)
                        return reject(err);
    ...
    Contract.resetAddress = function () {
    ...
    Contract.clone = function (json) {
        ...
        json = utils_1.default.merge({}, self._json || {}, json);
        temp._static_methods = this._static_methods;
        temp._properties = this._properties;
        temp._property_values = {};
        temp._json = json;
        utils_1.default.bootstrap(temp);
        temp.web3 = new Web3();
    ...
    Contract.addProp = function (key, fn) {
        var self = this;
        var getter = function () {
            if (fn.get != null) {
...
//# sourceMappingURL=contract.private.js.map